...
test("renders the summary test passed as prop", ()=>{
    ...
    //
    const summary = screen.getByText(/this is a summary/i);
...
// Use no more then 3 different expect statements to test the the existence of the summary value.
//3. The episode component displays a default value ('./stranger_things.png') when a image url is not provided. Create a new piece of test data with the image property set to null. 
