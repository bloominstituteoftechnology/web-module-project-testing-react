...
test('handleSelect is called when an season is selected', () => {
    ...
    render(<Show show={testShow} selectedSeason={'none'} handleSelect={fakeHandleSubmit}/>)
...
test('component renders when no seasons are selected and then re-renders with a season passed in', () => {
